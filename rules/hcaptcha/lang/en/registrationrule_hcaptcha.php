...
$string['settingsrequired'] = '<p>If you choose to use hCaptcha, you will first need to generate a Site Key and Secret.</p>You can generate these by logging into the <a href="https://dashboard.hcaptcha.com/sites" target="_blank">hCaptcha Sites</a> dashboard, more information can be found in the <a href="https://docs.hcaptcha.com/switch#get-your-hcaptcha-sitekey-and-secret-key">hCaptcha documentation</a>.';
