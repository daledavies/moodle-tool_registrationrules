...
$string['pluginname'] = 'Cloudflare Turnstile rule';
...
$string['settingsrequired'] = '<p>The Site Key and Secret are both required for this plugin to work.</p> You can generate these by logging into the Cloudflare dashboard and clicking "Turnstyle", more information can be found in the <a href="https://developers.cloudflare.com/turnstile/get-started/">Cloudflare Turnstile documentation</a>.';
